...
<html>
    ...
    <?php
	    ...
	    {
		echo "<p style='color:red;'>กรุณากรอกรหัสอาหารด้วยค่ะ</p>";
	    }
	    ...
	    {
		echo "<p style='color:red;'>กรุณากรอกรหัสตารางใหญ่ด้วยค่ะ</p>";
	    }
	    ...
	    {
		echo "<p style='color:red;'>กรุณากรอกจำนวนด้วยค่ะ</p>";
	    }
   ...
   ?>
		<h1>insert new mk_order_detail</h1>
				...
				<li>date_time  <input type="text" name="date_time"         value= "<?php echo $_SESSION["date_time"];?>" /> </li>
