    ...
    <head>
        ...
        <script>
            function confirm_delete(id)
            {
                ...
                if (r == true)
                {
                    window.open("catagory_delete.php?id="+id, "_self");
                }
                else
                {
    ...
    <body>
            ...
            <?php
                if(isset($_POST['btn']))
                {
                    ...
                    $catagory = searchcatagory(trim($_POST['text_to_search']),"name");
                    //print_r($catagory);
                    if(count($catagory) > 0)
                    {
                        echo "<table border='1' style= 'border-collapse: collapse;'>";
                            echo "<tr>";
                                $keys = array_keys ($catagory[0]);
                            ...
                            for($i =0 ;$i < count($catagory ) ; $i++)
                            {
                                ...
                                {
                                    $key = $keys[$j];
                                    echo "<td >".$catagory[$i][$key]."</td>";
                                }
                                $id = $catagory[$i]['id'];
                                
                                echo "<td >"."<a href = 'catagory_insert_form.php?action=edit&id=$id' >แก้ไข </a>"."</td>";
                                echo "<td >".
