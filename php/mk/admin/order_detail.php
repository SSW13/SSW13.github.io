...
<html lang="en">
	...
	<body>
		<a href="admin_close_order_paid.php?order_id=<?php echo $order_id; ?>">จ่ายเงืนแล้ว</a>
	</br>
	<hr>
	</br>
		<a href="admin_close_order_cancel.php?order_id=<?php echo $order_id; ?>">ยกเลิก</a>
			...
			*/
				for($i = 0 ; $i < count($detail) ; $i++)
				{
					echo "<tr>";
						...
						echo "</td>";
						echo "<td>";
						echo "<a href='admin_cancel_order_detail.php?order_detail_id=".$detail[$i]['id']."'>cancel</a> ";
						echo "</td>";
						echo "<td>";
