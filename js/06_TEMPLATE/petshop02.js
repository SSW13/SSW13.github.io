...
const SSWMySQL = require('./DatabaseModule');
const SSWDatabase = new SSWMySQL.MySQLDB();
const app = express();
...
app.get('/', (req, res) => {
    let con = SSWDatabase.openDatabaseConnection(SSWDatabase.getConfig(), function(err, con) {
        if (err) throw err;
